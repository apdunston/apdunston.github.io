...
MazeGame.copy2x2Matrix = function(xRows, yRows, matrix) {
  var copy = [];
...
MazeGame.translate = function(maze) {
  ...
  verticalSpaces = MazeGame.copy2x2Matrix(maze.x, maze.y, maze.horiz);
  horizontalSpaces = MazeGame.copy2x2Matrix(maze.x, maze.y, maze.verti);
